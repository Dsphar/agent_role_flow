...
4. Once confirmed:
   ...
   - Inform the user that the handoff is ready and instruct them to start a session so the next role loads after clearing context, via normal startup detection.
